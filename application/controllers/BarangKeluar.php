...
class BarangKeluar extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/kelola_inventory/v_barangKeluar', $data);
    ...
    {
        if (isset($_GET['term'])) {
            $result = $this->M_Bahan->getKodeNamaBarang($_GET['term']);
            if (count($result) > 0) {
    ...
    public function viewTambah()
    {
        ...
        $this->load->view('admin/kelola_inventory/v_tambahBarangKeluar');
    }
