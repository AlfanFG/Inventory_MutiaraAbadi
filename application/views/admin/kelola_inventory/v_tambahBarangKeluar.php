                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary">
                                <h5 style="color: white;">Tambah Barang Keluar</h5>
                            ...
                            <div class="card-body">
                                <form id="form-tambah" method="POST" enctype="multipart/form-data" style="margin-top: 40px">
                                    ...
                                    <?php
                                        $noSurat = $this->M_BarangKeluar->getNomorBarangKeluar();
                                    ?>
                                    <div class="row"  style="margin-top: 20px;">
                                        <div class="col-sm-3">
                                            <label for="roundText">Nomor Barang Keluar</label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <input type="text" id="noBrgKeluar" name="noBrgKeluar" class="form-control round noKeluar" placeholder="Masukan No. Surat Jalan">
                                                <div class="error"></div>
                                            </div>
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="col-sm-3">
                                            <label for="roundText">Tanggal Kirim</label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <input type="date" id="tglKirim" name="tglKirim" class="form-control round tglMasuk">
                                                <div class="error"></div>
                                            </div>
                                    ...
                                    <div class="brg-group">
                                        <div class="brg-group-no">
                                            <div class="divider">
                                                ...
                                                <div class="divider-text"><span class="badge bg-dark">Aksesoris Helm 1</span></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" id="helm1" name="helm1" class="form-control round helm" placeholder="Pilih Data Helm">
                                                    <div class="error"></div>
                                                </div>
                ...
                $('#addBarang').click(function() {
                    ...
                    $('.brg-group').append(`
                                            ...
                                            <div class="divider">
                                                ...
                                                <div class="divider-text"><span class="badge bg-dark" id="title` + i + `">Aksesoris Helm ` + i + `</span></div>
