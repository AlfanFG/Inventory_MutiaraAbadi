                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Data Perhitungan Produksi</h3>
                            </div>
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?= base_url('Dashboard') ?>">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Data Perhitungan Produksi
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                ...
                <section class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="<?= base_url('KalkulasiBahan/viewTambah') ?>" class="btn btn-primary shadow-sm" id="btn-tambah" style="width:200px !important; margin-left: 650px; position: relative; top:40px"><i class="fa fa-plus-square"></i> <span style="margin-left: 5px; ">Tambah Data</span></a>
                                            ...
                                            foreach ($perhitungan as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <!-- <a href="<?= base_url('KalkulasiBahan/detailBarangKeluar/' . $data['id_barangKeluar']) ?>" class="btn btn-primary btn-detail"><i class="fa fa-eye"></i></a> -->
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
