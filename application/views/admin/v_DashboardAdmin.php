                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Selamat Datang di Aplikasi Inventory Mutiara Abadi!</h4>
                                        <h3 class="mb-0 text-gray-600"><span class="badge bg-secondary"><?php echo $this->session->userdata('Nama'); ?></span></h3>
                                    </div>
                                    <div class="card-body">
