                                            ...
                                            foreach ($NamaPegawai as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="javascript:;" class="btn btn-warning btn-edit" data-id_pegawai="<?php echo $data['id_pegawai'] ?>" data-id_jabatan="<?php echo $data['id_jabatan'] ?>" data-Nama="<?php echo $data['NamaPegawai'] ?>" data-alamatPegawai="<?php echo $data['alamatPegawai'] ?>" data-nomorTelp="<?php echo $data['nomorTelp'] ?>" data-tgl_lahir="<?php echo $data['tgl_lahir'] ?>" data-statusPegawai="<?php echo $data['statusPegawai'] ?>"><i class="fa fa-edit"></i></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select type="text" name="id_jabatan" id="id_jabatan" class="form-select">
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#table-NamaPegawai").on('click', '.btn-edit', function() {
                    ...
                    var IdJabatan = $(this).data('id_jabatan');
